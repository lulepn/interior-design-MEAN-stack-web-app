  ...
  register() {
    this.servis.sviZabranjeni().subscribe((data : Zabranjeni[])=>{
      ...
      for(let i = 0; i < len; i++) {
        ...
        this.servis.registerK(this.username,this.password, this.firstName, this.lastName, this.email, 
          this.telefon, this._arrayBufferToBase64(this.imageSrc), 0).subscribe(respObj=>{
